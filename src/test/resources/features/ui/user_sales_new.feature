...
#    Then sales should be sorted by date in ascending order
    ...
    @TC_UI_USER_45 @TC_UI_USER_46 @TC_UI_USER_47 @TC_UI_USER_48
    Scenario Outline: User Sort Sales by column
      When user clicks on "<column>" column header
      Then sales should be sorted by <sortType> <order>

      Examples:
        | column      | sortType     | order              |
